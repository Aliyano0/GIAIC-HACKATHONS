...
const Browse = async () => {
  ...
  return (
    <div className="Container bg-[#f0f0f0] 2xl:w-[80%] pb-[70px] mx-auto sm:px-2 md:px-0 w-full flex flex-col items-center rounded-[20px] lg:rounded-[40px]">
      ...
      <div className="flex gap-[10px] flex-col sm:w-full md:w-auto sm:flex-row mb-4 lg:mb-5">
      ...
      <div className="flex gap-[10px] flex-col sm:w-full md:w-auto sm:flex-row">
        <Link href={"/Shop/Bed"}>
          <BrowseBanner
            size="large"
            image={bedImage}
